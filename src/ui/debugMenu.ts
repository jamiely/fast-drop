...
export const createDebugMenu = (
  ...
  menu.innerHTML = `
    ...
    <div class="debug-menu__group">
      ...
      <label>Display Z <span class="debug-menu__value" data-value-for="gameplay:statusDisplayZ">0.85</span><input type="range" min="-4" max="4" step="0.01" value="0.85" data-gameplay="statusDisplayZ" /></label>
