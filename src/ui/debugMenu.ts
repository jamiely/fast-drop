...
export const createDebugMenu = (
  ...
  menu.innerHTML = `
    ...
    <div class="debug-menu__group">
      ...
      <label>Drop cooldown (ms) <span class="debug-menu__value" data-value-for="gameplay:dropCooldownMs">160</span><input type="range" min="0" max="500" step="5" value="160" data-gameplay="dropCooldownMs" /></label>
