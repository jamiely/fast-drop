...
export const createDebugMenu = (
  ...
  menu.innerHTML = `
    ...
    <div class="debug-menu__group">
      ...
      <label>Platform arm length <span class="debug-menu__value" data-value-for="gameplay:platformArmLengthScale">1.00</span><input type="range" min="0.3" max="2.4" step="0.01" value="1" data-gameplay="platformArmLengthScale" /></label>
