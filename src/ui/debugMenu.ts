...
export const createDebugMenu = (
  ...
  menu.innerHTML = `
    ...
    <div class="debug-menu__group">
      ...
      <label>Ball size <span class="debug-menu__value" data-value-for="gameplay:ballSizeScale">2.00</span><input type="range" min="0.35" max="3.2" step="0.01" value="2" data-gameplay="ballSizeScale" /></label>
      <label>Center dome diameter <span class="debug-menu__value" data-value-for="gameplay:centerDomeDiameterScale">0.60</span><input type="range" min="0.3" max="3.2" step="0.01" value="0.6" data-gameplay="centerDomeDiameterScale" /></label>
      <label>Center dome steepness <span class="debug-menu__value" data-value-for="gameplay:centerDomeSteepnessScale">2.00</span><input type="range" min="0.35" max="3.5" step="0.01" value="2" data-gameplay="centerDomeSteepnessScale" /></label>
      <label>Center dome height <span class="debug-menu__value" data-value-for="gameplay:centerDomeHeightOffset">0.00</span><input type="range" min="-1.2" max="1.2" step="0.01" value="0" data-gameplay="centerDomeHeightOffset" /></label>
      <label>Platform arm length <span class="debug-menu__value" data-value-for="gameplay:platformArmLengthScale">0.15</span><input type="range" min="0.05" max="2.4" step="0.01" value="0.15" data-gameplay="platformArmLengthScale" /></label>
      ...
      <label>Display Z <span class="debug-menu__value" data-value-for="gameplay:statusDisplayZ">1.70</span><input type="range" min="-4" max="4" step="0.01" value="1.7" data-gameplay="statusDisplayZ" /></label>
      ...
      <label>Ball drop throttle (ms) <span class="debug-menu__value" data-value-for="gameplay:dropCooldownMs">130</span><input type="range" min="0" max="1000" step="5" value="130" data-gameplay="dropCooldownMs" /></label>
    ...
    button.addEventListener('click', () => {
      ...
      switch (action) {
        ...
        case 'force-game-over':
          ...
          break;
        case 'force-perfect-game-over':
          controls?.forcePerfectGameOver();
          break;
        case 'speed-05':
