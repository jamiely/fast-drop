...
export const createDebugMenu = (
  ...
  menu.innerHTML = `
    ...
    <div class="debug-menu__group">
      ...
      <label>Drop height <span class="debug-menu__value" data-value-for="gameplay:dropHeight">3.00</span><input type="range" min="0.4" max="8" step="0.05" value="3" data-gameplay="dropHeight" /></label>
      ...
      <label>Display size <span class="debug-menu__value" data-value-for="gameplay:statusDisplayScale">1.00</span><input type="range" min="0.2" max="3" step="0.01" value="1" data-gameplay="statusDisplayScale" /></label>
