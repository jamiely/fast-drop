...
export const createStatusDisplay = (): StatusDisplayVisual => {
  ...
  const draw = (data: StatusDisplayData, nowMs = getNowMs()) => {
    ...
    if (showEndedLayout) {
      ...
      const resultCenterY = canvas.height * 0.5;
    ...
    if (showAllDroppedMessage) {
      ...
      context.fillText('YOU', ballsX, ballsY - 88);
      context.font = 'bold 24px Arial';
      context.fillText('DROPPED ALL', ballsX, ballsY - 64);

      context.fillStyle = '#e54161';
      context.strokeStyle = '#ffffff';
      context.lineWidth = 5;
      context.font = 'bold 138px Arial';
      context.strokeText(String(ballsTotal), ballsX, ballsY + 10);
